...
.LBB1_2:                                #   Parent Loop BB1_1 Depth=1
	...
	movq	%rax, %rcx
	shlq	$12, %rcx
	vmovaps	(%r12,%rcx), %zmm0
	vmovaps	64(%r12,%rcx), %zmm1
	vmovaps	128(%r12,%rcx), %zmm2
	vmovaps	192(%r12,%rcx), %zmm3
	vmovaps	256(%r12,%rcx), %zmm4
	vmovaps	320(%r12,%rcx), %zmm5
	vmovaps	384(%r12,%rcx), %zmm6
	vmovaps	448(%r12,%rcx), %zmm7
	vmovaps	(%r14,%rcx), %zmm8
	vmovaps	64(%r14,%rcx), %zmm9
	vmovaps	128(%r14,%rcx), %zmm10
	vmovaps	192(%r14,%rcx), %zmm11
	vmovaps	256(%r14,%rcx), %zmm12
	vmovaps	320(%r14,%rcx), %zmm13
	vmovaps	384(%r14,%rcx), %zmm14
	vmovaps	448(%r14,%rcx), %zmm15
	prefetcht1	(%r15,%rcx)
	prefetcht1	64(%r15,%rcx)
	prefetcht1	128(%r15,%rcx)
	prefetcht1	192(%r15,%rcx)
	prefetcht1	256(%r15,%rcx)
	prefetcht1	320(%r15,%rcx)
	prefetcht1	384(%r15,%rcx)
	prefetcht1	448(%r15,%rcx)
	vmovaps	%zmm0, (%r15,%rcx)
	vmovaps	%zmm1, 64(%r15,%rcx)
	vmovaps	%zmm2, 128(%r15,%rcx)
	vmovaps	%zmm3, 192(%r15,%rcx)
	vmovaps	%zmm4, 256(%r15,%rcx)
	vmovaps	%zmm5, 320(%r15,%rcx)
	vmovaps	%zmm6, 384(%r15,%rcx)
	vmovaps	%zmm7, 448(%r15,%rcx)
	vmovaps	%zmm8, (%r12,%rcx)
	vmovaps	%zmm9, 64(%r12,%rcx)
	vmovaps	%zmm10, 128(%r12,%rcx)
	vmovaps	%zmm11, 192(%r12,%rcx)
	vmovaps	%zmm12, 256(%r12,%rcx)
	vmovaps	%zmm13, 320(%r12,%rcx)
	vmovaps	%zmm14, 384(%r12,%rcx)
	vmovaps	%zmm15, 448(%r12,%rcx)
	vmovaps	512(%r12,%rcx), %zmm0
	vmovaps	576(%r12,%rcx), %zmm1
	vmovaps	640(%r12,%rcx), %zmm2
	vmovaps	704(%r12,%rcx), %zmm3
	vmovaps	768(%r12,%rcx), %zmm4
	vmovaps	832(%r12,%rcx), %zmm5
	vmovaps	896(%r12,%rcx), %zmm6
	vmovaps	960(%r12,%rcx), %zmm7
	vmovaps	512(%r14,%rcx), %zmm8
	vmovaps	576(%r14,%rcx), %zmm9
	vmovaps	640(%r14,%rcx), %zmm10
	vmovaps	704(%r14,%rcx), %zmm11
	vmovaps	768(%r14,%rcx), %zmm12
	vmovaps	832(%r14,%rcx), %zmm13
	vmovaps	896(%r14,%rcx), %zmm14
	vmovaps	960(%r14,%rcx), %zmm15
	prefetcht1	512(%r15,%rcx)
	prefetcht1	576(%r15,%rcx)
	prefetcht1	640(%r15,%rcx)
	prefetcht1	704(%r15,%rcx)
	prefetcht1	768(%r15,%rcx)
	prefetcht1	832(%r15,%rcx)
	prefetcht1	896(%r15,%rcx)
	prefetcht1	960(%r15,%rcx)
	vmovaps	%zmm0, 512(%r15,%rcx)
	vmovaps	%zmm1, 576(%r15,%rcx)
	vmovaps	%zmm2, 640(%r15,%rcx)
	vmovaps	%zmm3, 704(%r15,%rcx)
	vmovaps	%zmm4, 768(%r15,%rcx)
	vmovaps	%zmm5, 832(%r15,%rcx)
	vmovaps	%zmm6, 896(%r15,%rcx)
	vmovaps	%zmm7, 960(%r15,%rcx)
	vmovaps	%zmm8, 512(%r12,%rcx)
	vmovaps	%zmm9, 576(%r12,%rcx)
	vmovaps	%zmm10, 640(%r12,%rcx)
	vmovaps	%zmm11, 704(%r12,%rcx)
	vmovaps	%zmm12, 768(%r12,%rcx)
	vmovaps	%zmm13, 832(%r12,%rcx)
	vmovaps	%zmm14, 896(%r12,%rcx)
	vmovaps	%zmm15, 960(%r12,%rcx)
	vmovaps	1024(%r12,%rcx), %zmm0
	vmovaps	1088(%r12,%rcx), %zmm1
	vmovaps	1152(%r12,%rcx), %zmm2
	vmovaps	1216(%r12,%rcx), %zmm3
	vmovaps	1280(%r12,%rcx), %zmm4
	vmovaps	1344(%r12,%rcx), %zmm5
	vmovaps	1408(%r12,%rcx), %zmm6
	vmovaps	1472(%r12,%rcx), %zmm7
	vmovaps	1024(%r14,%rcx), %zmm8
	vmovaps	1088(%r14,%rcx), %zmm9
	vmovaps	1152(%r14,%rcx), %zmm10
	vmovaps	1216(%r14,%rcx), %zmm11
	vmovaps	1280(%r14,%rcx), %zmm12
	vmovaps	1344(%r14,%rcx), %zmm13
	vmovaps	1408(%r14,%rcx), %zmm14
	vmovaps	1472(%r14,%rcx), %zmm15
	prefetcht1	1024(%r15,%rcx)
	prefetcht1	1088(%r15,%rcx)
	prefetcht1	1152(%r15,%rcx)
	prefetcht1	1216(%r15,%rcx)
	prefetcht1	1280(%r15,%rcx)
	prefetcht1	1344(%r15,%rcx)
	prefetcht1	1408(%r15,%rcx)
	prefetcht1	1472(%r15,%rcx)
	vmovaps	%zmm0, 1024(%r15,%rcx)
	vmovaps	%zmm1, 1088(%r15,%rcx)
	vmovaps	%zmm2, 1152(%r15,%rcx)
	vmovaps	%zmm3, 1216(%r15,%rcx)
	vmovaps	%zmm4, 1280(%r15,%rcx)
	vmovaps	%zmm5, 1344(%r15,%rcx)
	vmovaps	%zmm6, 1408(%r15,%rcx)
	vmovaps	%zmm7, 1472(%r15,%rcx)
	vmovaps	%zmm8, 1024(%r12,%rcx)
	vmovaps	%zmm9, 1088(%r12,%rcx)
	vmovaps	%zmm10, 1152(%r12,%rcx)
	vmovaps	%zmm11, 1216(%r12,%rcx)
	vmovaps	%zmm12, 1280(%r12,%rcx)
	vmovaps	%zmm13, 1344(%r12,%rcx)
	vmovaps	%zmm14, 1408(%r12,%rcx)
	vmovaps	%zmm15, 1472(%r12,%rcx)
	vmovaps	1536(%r12,%rcx), %zmm0
	vmovaps	1600(%r12,%rcx), %zmm1
	vmovaps	1664(%r12,%rcx), %zmm2
	vmovaps	1728(%r12,%rcx), %zmm3
	vmovaps	1792(%r12,%rcx), %zmm4
	vmovaps	1856(%r12,%rcx), %zmm5
	vmovaps	1920(%r12,%rcx), %zmm6
	vmovaps	1984(%r12,%rcx), %zmm7
	vmovaps	1536(%r14,%rcx), %zmm8
	vmovaps	1600(%r14,%rcx), %zmm9
	vmovaps	1664(%r14,%rcx), %zmm10
	vmovaps	1728(%r14,%rcx), %zmm11
	vmovaps	1792(%r14,%rcx), %zmm12
	vmovaps	1856(%r14,%rcx), %zmm13
	vmovaps	1920(%r14,%rcx), %zmm14
	vmovaps	1984(%r14,%rcx), %zmm15
	prefetcht1	1536(%r15,%rcx)
	prefetcht1	1600(%r15,%rcx)
	prefetcht1	1664(%r15,%rcx)
	prefetcht1	1728(%r15,%rcx)
	prefetcht1	1792(%r15,%rcx)
	prefetcht1	1856(%r15,%rcx)
	prefetcht1	1920(%r15,%rcx)
	prefetcht1	1984(%r15,%rcx)
	vmovaps	%zmm0, 1536(%r15,%rcx)
	vmovaps	%zmm1, 1600(%r15,%rcx)
	vmovaps	%zmm2, 1664(%r15,%rcx)
	vmovaps	%zmm3, 1728(%r15,%rcx)
	vmovaps	%zmm4, 1792(%r15,%rcx)
	vmovaps	%zmm5, 1856(%r15,%rcx)
	vmovaps	%zmm6, 1920(%r15,%rcx)
	vmovaps	%zmm7, 1984(%r15,%rcx)
	vmovaps	%zmm8, 1536(%r12,%rcx)
	vmovaps	%zmm9, 1600(%r12,%rcx)
	vmovaps	%zmm10, 1664(%r12,%rcx)
	vmovaps	%zmm11, 1728(%r12,%rcx)
	vmovaps	%zmm12, 1792(%r12,%rcx)
	vmovaps	%zmm13, 1856(%r12,%rcx)
	vmovaps	%zmm14, 1920(%r12,%rcx)
	vmovaps	%zmm15, 1984(%r12,%rcx)
	vmovaps	2048(%r12,%rcx), %zmm0
	vmovaps	2112(%r12,%rcx), %zmm1
	vmovaps	2176(%r12,%rcx), %zmm2
	vmovaps	2240(%r12,%rcx), %zmm3
	vmovaps	2304(%r12,%rcx), %zmm4
	vmovaps	2368(%r12,%rcx), %zmm5
	vmovaps	2432(%r12,%rcx), %zmm6
	vmovaps	2496(%r12,%rcx), %zmm7
	vmovaps	2048(%r14,%rcx), %zmm8
	vmovaps	2112(%r14,%rcx), %zmm9
	vmovaps	2176(%r14,%rcx), %zmm10
	vmovaps	2240(%r14,%rcx), %zmm11
	vmovaps	2304(%r14,%rcx), %zmm12
	vmovaps	2368(%r14,%rcx), %zmm13
	vmovaps	2432(%r14,%rcx), %zmm14
	vmovaps	2496(%r14,%rcx), %zmm15
	prefetcht1	2048(%r15,%rcx)
	prefetcht1	2112(%r15,%rcx)
	prefetcht1	2176(%r15,%rcx)
	prefetcht1	2240(%r15,%rcx)
	prefetcht1	2304(%r15,%rcx)
	prefetcht1	2368(%r15,%rcx)
	prefetcht1	2432(%r15,%rcx)
	prefetcht1	2496(%r15,%rcx)
	vmovaps	%zmm0, 2048(%r15,%rcx)
	vmovaps	%zmm1, 2112(%r15,%rcx)
	vmovaps	%zmm2, 2176(%r15,%rcx)
	vmovaps	%zmm3, 2240(%r15,%rcx)
	vmovaps	%zmm4, 2304(%r15,%rcx)
	vmovaps	%zmm5, 2368(%r15,%rcx)
	vmovaps	%zmm6, 2432(%r15,%rcx)
	vmovaps	%zmm7, 2496(%r15,%rcx)
	vmovaps	%zmm8, 2048(%r12,%rcx)
	vmovaps	%zmm9, 2112(%r12,%rcx)
	vmovaps	%zmm10, 2176(%r12,%rcx)
	vmovaps	%zmm11, 2240(%r12,%rcx)
	vmovaps	%zmm12, 2304(%r12,%rcx)
	vmovaps	%zmm13, 2368(%r12,%rcx)
	vmovaps	%zmm14, 2432(%r12,%rcx)
	vmovaps	%zmm15, 2496(%r12,%rcx)
	vmovaps	2560(%r12,%rcx), %zmm0
	vmovaps	2624(%r12,%rcx), %zmm1
	vmovaps	2688(%r12,%rcx), %zmm2
	vmovaps	2752(%r12,%rcx), %zmm3
	vmovaps	2816(%r12,%rcx), %zmm4
	vmovaps	2880(%r12,%rcx), %zmm5
	vmovaps	2944(%r12,%rcx), %zmm6
	vmovaps	3008(%r12,%rcx), %zmm7
	vmovaps	2560(%r14,%rcx), %zmm8
	vmovaps	2624(%r14,%rcx), %zmm9
	vmovaps	2688(%r14,%rcx), %zmm10
	vmovaps	2752(%r14,%rcx), %zmm11
	vmovaps	2816(%r14,%rcx), %zmm12
	vmovaps	2880(%r14,%rcx), %zmm13
	vmovaps	2944(%r14,%rcx), %zmm14
	vmovaps	3008(%r14,%rcx), %zmm15
	prefetcht1	2560(%r15,%rcx)
	prefetcht1	2624(%r15,%rcx)
	prefetcht1	2688(%r15,%rcx)
	prefetcht1	2752(%r15,%rcx)
	prefetcht1	2816(%r15,%rcx)
	prefetcht1	2880(%r15,%rcx)
	prefetcht1	2944(%r15,%rcx)
	prefetcht1	3008(%r15,%rcx)
	vmovaps	%zmm0, 2560(%r15,%rcx)
	vmovaps	%zmm1, 2624(%r15,%rcx)
	vmovaps	%zmm2, 2688(%r15,%rcx)
	vmovaps	%zmm3, 2752(%r15,%rcx)
	vmovaps	%zmm4, 2816(%r15,%rcx)
	vmovaps	%zmm5, 2880(%r15,%rcx)
	vmovaps	%zmm6, 2944(%r15,%rcx)
	vmovaps	%zmm7, 3008(%r15,%rcx)
	vmovaps	%zmm8, 2560(%r12,%rcx)
	vmovaps	%zmm9, 2624(%r12,%rcx)
	vmovaps	%zmm10, 2688(%r12,%rcx)
	vmovaps	%zmm11, 2752(%r12,%rcx)
	vmovaps	%zmm12, 2816(%r12,%rcx)
	vmovaps	%zmm13, 2880(%r12,%rcx)
	vmovaps	%zmm14, 2944(%r12,%rcx)
	vmovaps	%zmm15, 3008(%r12,%rcx)
	vmovaps	3072(%r12,%rcx), %zmm0
	vmovaps	3136(%r12,%rcx), %zmm1
	vmovaps	3200(%r12,%rcx), %zmm2
	vmovaps	3264(%r12,%rcx), %zmm3
	vmovaps	3328(%r12,%rcx), %zmm4
	vmovaps	3392(%r12,%rcx), %zmm5
	vmovaps	3456(%r12,%rcx), %zmm6
	vmovaps	3520(%r12,%rcx), %zmm7
	vmovaps	3072(%r14,%rcx), %zmm8
	vmovaps	3136(%r14,%rcx), %zmm9
	vmovaps	3200(%r14,%rcx), %zmm10
	vmovaps	3264(%r14,%rcx), %zmm11
	vmovaps	3328(%r14,%rcx), %zmm12
	vmovaps	3392(%r14,%rcx), %zmm13
	vmovaps	3456(%r14,%rcx), %zmm14
	vmovaps	3520(%r14,%rcx), %zmm15
	prefetcht1	3072(%r15,%rcx)
	prefetcht1	3136(%r15,%rcx)
	prefetcht1	3200(%r15,%rcx)
	prefetcht1	3264(%r15,%rcx)
	prefetcht1	3328(%r15,%rcx)
	prefetcht1	3392(%r15,%rcx)
	prefetcht1	3456(%r15,%rcx)
	prefetcht1	3520(%r15,%rcx)
	vmovaps	%zmm0, 3072(%r15,%rcx)
	vmovaps	%zmm1, 3136(%r15,%rcx)
	vmovaps	%zmm2, 3200(%r15,%rcx)
	vmovaps	%zmm3, 3264(%r15,%rcx)
	vmovaps	%zmm4, 3328(%r15,%rcx)
	vmovaps	%zmm5, 3392(%r15,%rcx)
	vmovaps	%zmm6, 3456(%r15,%rcx)
	vmovaps	%zmm7, 3520(%r15,%rcx)
	vmovaps	%zmm8, 3072(%r12,%rcx)
	vmovaps	%zmm9, 3136(%r12,%rcx)
	vmovaps	%zmm10, 3200(%r12,%rcx)
	vmovaps	%zmm11, 3264(%r12,%rcx)
	vmovaps	%zmm12, 3328(%r12,%rcx)
	vmovaps	%zmm13, 3392(%r12,%rcx)
	vmovaps	%zmm14, 3456(%r12,%rcx)
	vmovaps	%zmm15, 3520(%r12,%rcx)
	incq	%rax
